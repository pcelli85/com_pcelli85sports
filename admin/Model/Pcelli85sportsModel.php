...
/**
 * Methods supporting a list of pcelli85sports records.
 *
 * @since  1.6
 */
class pcelli85sportsModel extends ListModel
{
	/**
	 * Constructor.
	 *
	...
	protected function getListQuery()
	{
		...
		$query->select(
			$this->getState(
				'list.select',
				'a.*, (select categoria FROM #__pcelli85sports_categorie WHERE id = a.categoria_id) AS categoria'
			)
		);
