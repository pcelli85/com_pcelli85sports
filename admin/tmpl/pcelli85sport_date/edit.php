...
$walk_id = $app->getUserState('com_pcelli85sports.walk_id');
...
<form action="<?php echo Route::_('index.php?option=com_pcelli85sports&view=pcelli85sport_date&layout=edit&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="pcelli85sport-dates-form" class="form-validate">
	...
	<div>
		...
		<?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'details', Text::_('COM_PCELLI85SPORTS_MYWALK_DATE_TAB_DETAILS')); ?>
		<div class="row">
			<div class="col-md-9">
				<div class="row">
					<div class="col-md-6">
