...
<form action="<?php echo Route::_('index.php?option=com_pcelli85sports&view=pcelli85sportcategoria&layout=edit&id=' . (int) $this->item->id); ?>"
	method="post" name="adminForm" id="pcelli85sportscategorie-form" class="form-validate">
