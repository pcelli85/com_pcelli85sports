...
class Pcelli85sportsModel extends ListModel
{
	...
	protected function populateState($ordering = 'ordering', $direction = 'ASC')
	{
		...
		$orderCol = $app->input->get('filter_order', 'a.date_event');

		if (!in_array($orderCol, $this->filter_fields))
		{
			$orderCol = 'a.date_event';
		}
	...
	protected function getListQuery()
	{
		...
		$query->order($this->getState('list.ordering', 'a.date_event') . ' ' . $this->getState('list.direction', 'ASC'));
